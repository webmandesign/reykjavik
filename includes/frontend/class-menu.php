		...
		public static function primary() {
			...
			public static function primary_menu_args( $mobile_nav = true, $fallback = false ) {
				...
				// Helper variables
					...
					$a11y_link = '<li class="menu-toggle-skip-link-container"><a href="#menu-toggle" class="menu-toggle-skip-link">' . esc_html__( 'Skip to menu toggle button', 'reykjavik' ) . '</a></li>';
